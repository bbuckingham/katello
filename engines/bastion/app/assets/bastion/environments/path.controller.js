    ...
    ['$scope', '$q', 'gettext', '$timeout', '$http', 'Routes', 'Environment', 'FormUtils',
        function($scope, $q, gettext, $timeout, $http, Routes, Environment, FormUtils) {
            ...
            $scope.close = function() {
                ...
                $scope.environmentsTable.rows[$scope.row.pathId].showCreate = false;
                $scope.environmentsTable.rows[$scope.row.pathId].showEdit = false;
            };
            ...
            $scope.initiateCreateEnvironment = function() {
                ...
                $scope.environment = new Environment();
                $scope.environmentsTable.rows[$scope.row.pathId].showCreate = true;
            };
